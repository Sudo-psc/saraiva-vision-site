...
// Guard for legacy inline preloader references (no-op to avoid ReferenceError)
if (typeof window !== 'undefined' && !('preloadDoctorImage' in window)) {
    window.preloadDoctorImage = () => { };
}
