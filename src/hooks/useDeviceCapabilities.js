...
export const useDeviceCapabilities = () => {
    ...
    const isLowEndDevice = useMemo(() => {
        ...
        if (capabilities.connectionType && ['slow-2g', '2g', '3g'].includes(capabilities.connectionType)) {
    ...
    useEffect(() => {
        ...
        return () => {
            if (navigator.connection) {
                navigator.connection.removeEventListener('change', detectCapabilities);
            }
