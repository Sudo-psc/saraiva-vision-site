export const blogPosts = [
  {
    ...
    excerpt: 'Catarata: sintomas e cirurgia. Dr. Philipe Saraiva Cruz (CRM-MG 69.870) e sua equipe qualificada realizam avaliações completas, incluindo exames como topografia corneal e biometria, para um diagnóstico preciso. Lembre-se: o acompanhamento regular, pelo menos uma vez ao ano, é vital para prevenir progressão e manter a saúde ocular em dia.',
    content: `
  ...
  },
  {
    ...
    content: `
      ...
      <h3>Referências:</h3>
      <ol>
        <li>Sociedade Brasileira de Oftalmologia. Diretrizes de Oftalmologia Pediátrica. 2024.</li>
  ...
  },
  {
    ...
    excerpt: 'Entenda tudo sobre pterígio (carne no olho): causas, sintomas, prevenção e tratamento cirúrgicos. Guia completo com informações atualizadas para proteger sua visão.',
    content: `
    ...
    seo: {
      ...
      metaDescription: 'Entenda tudo sobre pterígio (carne no olho): causas, sintomas, prevenção e tratamento cirúrgicos. Guia completo para proteger sua visão.',
