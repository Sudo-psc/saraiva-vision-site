...
const ActionButtons = ({
  ...
  const handleWhatsApp = () => {
    window.open('https://wa.me/5533998601427', '_blank', 'noopener,noreferrer');
  };
  ...
  return (
    <motion.div
      ...
      className={`bg-gradient-to-r from-cyan-500 to-cyan-600 rounded-2xl p-6 shadow-xl ${className}`}
      role="complementary"
    ...
    >
      ...
      <div className="space-y-3">
        {showAppointment && (
          <Button
            ...
            variant="secondary"
            className="w-full bg-white text-cyan-600 hover:bg-cyan-50 shadow-md hover:shadow-lg transition-all group"
          >
        ...
        {showContact && (
          <Button
            ...
            variant="outline"
            className="w-full bg-cyan-600 text-white border-cyan-700 hover:bg-cyan-700 shadow-md hover:shadow-lg transition-all group"
          >
      ...
      <div className="mt-6 pt-6 border-t border-white/20">
        ...
        <a
          ...
          className="flex items-center gap-2 text-white hover:text-cyan-100 transition-colors group"
        >
