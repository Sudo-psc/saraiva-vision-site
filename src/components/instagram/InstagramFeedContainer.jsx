...
const InstagramFeedContainer = ({
    ...
    const fetchPosts = useCallback(async (force = false) => {
        try {
            ...
            if (enableAccessibility) {
                announce(`Error loading Instagram posts: ${err.message}`, 'assertive');
            }
    ...
    }, [maxPosts, showStats, getCachedData, setCachedData, onSuccess, onError]);
    ...
    return (
        ...
        >
            ...
            {error && posts.length === 0 && (
                ...
                >
                    <AlertCircle className="w-12 h-12 text-amber-500 mb-4" aria-hidden="true" />
                    <h3 id="error-title" className="text-lg font-semibold mb-2">Unable to load posts</h3>
                    <p id="error-description" className="text-gray-600 mb-4 max-w-md">
                        {isOnline
                            ? 'There was an error loading Instagram posts. Please try again.'
                    ...
                    >
                        ...
                        {enableAccessibility && (
                            <span id="retry-button-description" className="sr-only">
                                Attempt to reload Instagram posts
                            </span>
                        )}
                    </button>
                </div>
