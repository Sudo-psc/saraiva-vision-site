...
import { normalizeReview } from '@/utils/googleReviews.js';
...
const GoogleReviewsWidget = ({
    ...
    const normalizedReviews = useMemo(() => {
        ...
        logger.info('Starting review normalization', {
            ...
            placeDataReviewCount: placeData?.reviews?.length || 0,
        ...
        const reviewsToNormalize = placeData?.reviews || apiReviews || [];
    ...
    const stats = useMemo(() => {
        ...
        logger.info('Statistics calculation completed', {
            ...
            hasPlaceDataIssues: !!(placeData && (placeData.error || placeData.rating <= 0)),
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-white shadow-sm">
                        <img
                            ...
                            loading="lazy"
                            onError={(e) => { e.target.src = '/images/avatar-female-brunette-320w.avif'; }}
                        />
                    </div>
                </div>
            </CardContent>
    ...
    const whatsappUrl = 'https://wa.me/5533998601427';
