...
const DEFAULT_DESCRIPTION = 'Clínica oftalmológica especializada com Dr. Philipe Saraiva Cruz (CRM-MG 69.870 | Oftalmologista RQE 307527). Atendimento humanizado e tecnologia de ponta em Caratinga, MG.';
const DEFAULT_IMAGE = 'https://saraivavision.com.br/opengraph-logo.png';
