          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 relative z-10">
              <div className="space-y-4">
                <div className="rounded-2xl overflow-hidden shadow-3d hover:shadow-3d-hover card-hover h-64 relative">
                  <Image
                    src={imageUrls[0]}
                    alt={imageAlts[0]}
                    fill
                ...
                <div className="rounded-2xl overflow-hidden shadow-3d hover:shadow-3d-hover card-hover h-40 relative">
                  <Image
                    src={imageUrls[1]}
                    alt={imageAlts[1]}
                    fill
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative aspect-[3/4] overflow-hidden rounded-3xl shadow-2xl bg-gradient-to-b from-slate-50 to-white" style={{ transform: "translateZ(0)" }}>
                      <Image
                        src="/img/drphilipe_jaleco Medium.jpeg"
