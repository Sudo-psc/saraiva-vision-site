...
const Testimonials: React.FC<TestimonialsProps> = ({ limit }) => {
  ...
  const fallbackTestimonials = useMemo<Testimonial[]>(() => [
    {
      id: 'local-1',
      name: 'Maria Silva',
      content: 'Excelente atendimento! A Dra. Saraiva é muito atenciosa e explica tudo com clareza.',
      rating: 5,
      image: images[0],
      role: 'Paciente Saraiva Vision'
    },
    {
      id: 'local-2',
      name: 'João Santos',
      content: 'Clínica moderna e profissionais competentes. Recomendo!',
      rating: 5,
      image: images[1],
      role: 'Paciente Saraiva Vision'
    },
    {
      id: 'local-3',
      name: 'Ana Costa',
      content: 'Ótima experiência desde o agendamento até a consulta. Equipe muito profissional.',
      rating: 5,
      image: images[2],
      role: 'Paciente Saraiva Vision'
    }
  ...
  const googleTestimonials = useMemo<Testimonial[]>(() =>
    Array.isArray(googleReviews) && googleReviews.length > 0
      ? googleReviews.map((review, index) => ({
          id: review.id || `google-${index}`,
          name: review.reviewer?.displayName || 'Paciente Saraiva Vision',
          content: review.comment || 'Atendimento impecável e equipe atenciosa!',
          rating: review.starRating || 5,
          image: review.reviewer?.profilePhotoUrl || images[index % images.length],
          role: 'Paciente Saraiva Vision',
        }))
      : [],
    [googleReviews, images]
  );
      ...
      <div className="max-w-7xl mx-auto px-[7%] relative z-10 testimonials-container">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            Histórias reais de quem confia na Saraiva Vision
          </p>
        </motion.div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <div className="w-16 h-16 rounded-full overflow-hidden bg-slate-200 ring-4 ring-blue-100 relative">
                    <Image
        ...
        {limit && testimonials.length > limit && (
          <div className="mt-10 text-center">
            <Link href="/sobre" className="text-blue-600 font-medium hover:underline inline-flex items-center gap-1">
