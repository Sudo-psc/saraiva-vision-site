/**
 * WordPress JWT API Integration Test Suite
 * Tests JWT authentication without React dependencies
 */
...
describe('WordPress JWT API Integration', () => {
  let jwtService;
  let blogService;
  ...
  beforeEach(() => {
    ...
    global.sessionStorage = {
      _data: {},
      getItem: vi.fn((key) => global.sessionStorage._data[key]),
      setItem: vi.fn((key, value) => { global.sessionStorage._data[key] = value; }),
      removeItem: vi.fn((key) => { delete global.sessionStorage._data[key]; }),
      clear: vi.fn(() => { global.sessionStorage._data = {}; })
    };
