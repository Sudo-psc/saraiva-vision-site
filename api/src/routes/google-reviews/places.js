/**
 * Google Places Reviews API Endpoint
    ...
    try {
        ...
        const result = {
            ...
            pagination: {
                ...
                limit: transformedReviews.length,
                offset: 0,
...
function calculateStats(reviews, place) {
    ...
    // Estimate distribution for all reviews (this is approximate since we only have 5 reviews max)
